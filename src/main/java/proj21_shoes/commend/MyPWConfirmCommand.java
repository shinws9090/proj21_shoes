...
public class MyPWConfirmCommand {			//	회원상세정보
	...
	public MyPWConfirmCommand() {
		// TODO Auto-generated constructor stub
	}



	public MyPWConfirmCommand(String memberName, String email) {
		super();
	...
	public MyPWConfirmCommand(String memberId) {
		super();
	...
	public MyPWConfirmCommand(String memberId, String memberPwd, String memberName, boolean gender, LocalDate birthday,
	...
	public MyPWConfirmCommand(String memberId, String memberPwd, String memberName, boolean gender, String email, String tel,
	...
	public MyPWConfirmCommand(String memberId, String memberPwd, String memberName, boolean gender) {
		super();
		this.memberId = memberId;
		this.memberPwd = memberPwd;
		this.memberName = memberName;
