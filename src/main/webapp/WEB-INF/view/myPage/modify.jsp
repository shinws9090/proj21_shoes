...
<body class="main-layout">
	...
	<section id = "signUpForm">
		...
		<form:form action="modify/${memberDetail.memberId}" modelAttribute="memberDetail"> <!-- dto명 -->
		<form:errors/>
		<div class="left">
		<p>
			<label>회원 아이디: 
			<form:input  type="text" path="memberId" placeholder="${memberDetail.memberId}" id="member_id" readonly="true" />  
			<form:errors path="memberId" />
			</label>
		</p>
		
		<p>
			<label>기존 비밀번호:  <!-- 얘는 db에 있는 값과 비교해야한다! 컨트롤러에서! -->
		...
		<p>
			...
			<form:input path="memberName" placeholder="Name" id="member_name"  value="${memberDetail.memberName }"/>  
 ...
 성별
	<label for="gender">	  
		...
		<p>
			...
			<form:input path="birthday" type="date" id="birthday" value="${memberDetail.birthday}" placeholder="하이폰(-) 없이 입력해주세요" />  
		...
		<p>
			<label for="email">이메일: 
			<form:input type="email" path="email" id="email" placeholder="E-mail" value="${memberDetail.email}"/>  
