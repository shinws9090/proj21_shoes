...
<body class="main-layout">
	...
	<!-- 문의하기  입력  -->
		...
		<tr>
			...
			<br>
			<form:input type="text" name="title" path="title" id="title" placeholder="문의제목을 작성해주세요" size="100"/>  
			</td>
			</tr>
		<tr>
			<td><a>문의내용:</a></td>
			...
			<br>
			 <textarea rows="10" cols="50"  name="content" id="content" placeholder="문의내용을 작성해주세요" style="width:98%; height:98%;" maxlength="1000" ></textarea>
			</td>
		</tr>
