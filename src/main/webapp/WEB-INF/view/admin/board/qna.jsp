						...
						<table style="width: 90%; text-align: center;">				
							...
							<tr>
								...
								<tr>
									...
									<td><a href="${contextPath}/admin/board/qnaDetail?searchType=${param.searchType}&resOX=${qnaList.resOX}&boardCode=${qnaList.boardCode}"><c:out value="${qnaList.title}" /></a></td>
