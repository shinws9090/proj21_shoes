...
<body class="main-layout">
	...
	<section>
		...
		<form name="productReg" action="productReg" enctype="multipart/form-data" method="get">
			<!-- form 타이틀 -->
		<div id="title">
			<h1>제품등록</h1>
		</div>
		...
		<div id="point">
			...
			<div id="regForm">
				<div id="form">
					...
					<input type="text" name="productCode" id="productCode" value='10'>
					<br>
					
					<label><span class="red">* </span>상품명</label>
					<input type="text" name="productName" id="productName" value='신발임'>
					<br>					
					...
					<input type="text" name="gender" id="gender" value='남'>
					<br>
					...
					<input type="text" name="material" value='가죽'>
					<br>
					
					<label><span class="red">* </span>계절</label>
					<input type="text" name="season" value='겨울'>
					<br>
					
					<label><span class="red">* </span>제조일</label>
					<input type="text" name="madeDate" value='20210101'>
					<br>
															
					<label><span class="red">* </span>공급가격 <span class="cnt">(1개당)</span></label>
					<input type="text" name="costPrice" value="440000">
					<br>
					
					<label><span class="red">* </span>판매가격 <span class="cnt">(1개당)</span></label>
					<input type="text" name="sellPrice" value="550000">
					<br>					
					
					<label><span class="red">* </span>등록일</label>
					<input type="text" name="registDate" value='20210101'>
					<br>
					
					<label><span class="red">* </span>누적등록수량</label>
					<input type="text" name="cumulativeRegistCount" value="1">
					<br>
					
					<label><span class="red">* </span>누적판매수량</label>
					<input type="text" name="cumulativeSellCount" value="1">
					<br>
					
					<label><span class="red">* </span>등록사원정보</label>
					<input type="text" name="employee" class="text" value="1">
					<br>					
