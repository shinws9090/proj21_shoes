	...
	<section>
		...
		<!-- 문의하기  입력  -->
				...
				<fieldset>
				    ...
				    <div class="form-group row">
				      <label class="col-sm-2 col-form-label">주문 코드  : </label>
				      <div class="col-sm-10">
				        <input type="text" readonly class="form-control-plaintext" value="${orderCode}" name="orderNum">
				      </div>
				    </div>
					...
					<div class="form-group">
				      ...
				      <textarea class="form-control" rows="10" cols="50" id="content" name="content">${reView.content }</textarea>
				    </div>
					<div class="form-group">
