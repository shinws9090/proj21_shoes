...
insert into product values
	(11111,'카시안 다크브라운 샌들',1,'man',555,'천연(소)가죽','S/S',now(),178000,124900,now(),1,1,101),
	(22222,'팀버랜드 프리미엄',3,'man',777,'레더','S/S',now(),258000,246000,now(),1,1,101),
	(33333,'큐빅 블링 스퀘어뮬',4,'woman',111,'합성섬유+천연소가죽','여름',now(),69000,59000,now(),1,1,101),
...
insert into cart values 
	...
	(2,111112,280,22222,2,20),
	(3,111113,230,33333,3,20),
	(4,111114,260,55555,4,20),
	(5,111115,270,66666,5,20);
...
insert into review values
	...
	(2,10002,'신발이 편해요','쿠션감 짱짱!!',now()),
	(3,10003,'배송이 너무 늦었어요','한참 기다렸어요ㅠㅠ',now()),
	(4,10004,'맘에 들어요','재구매각이에요...!',now()),
	(5,10005,'고민하다가 샀어요','사길 잘한 것 같아요',now());
