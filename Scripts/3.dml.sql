...
insert into product values
	(11111,'카시안 다크브라운 샌들',1,'men',555,'천연(소)가죽','S/S',now(),100000,150000,now(),100,0,101),
	(22222,'팀버랜드 프리미엄',3,'men',777,'레더','S/S',now(),200000,250000,now(),100,0,101),
	(33333,'큐빅 블링 스퀘어뮬',4,'women',111,'합성섬유+천연소가죽','여름',now(),40000,70000,now(),1000,0,101),
	(55555,'척70하이',5,'free',888,'면','사계절',now(),100000,170000,now(),100,0,101),
	(66666,'비-쿨',6,'free',666,'니트 메쉬','여름',now(),80000,100000,now(),100,0,101);
...
insert into orderoption values
	(11111,1,270,100,'brown'),
	(22222,2,280,100,'yellow'),
	(33333,1,230,100,'black'),
	(33333,2,230,100,'beige'),
	(33333,3,230,100,'pink'),
	(55555,4,260,100,'mixed-color'),
	(66666,5,270,100,'black');

insert into orderoption values
	(33333,1,260,100,'black'),
	(33333,1,250,100,'black'),
	(33333,1,240,100,'black'),
	(33333,4,240,100,'sett'),
	(33333,5,260,100,'xcvb'),
	(33333,6,270,100,'sdf');
...
insert into `order` values
	(10014,111111,now(),null,50000,1,false,null,false),
...
insert into review values
	(1,10014,11111,'이 가격에 이 퀄리티 리얼?','가성비 좋아요~',now()),
